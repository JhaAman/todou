...
-- An earlier draft used 20260723000000 for this feature; normalize both histories before upgrading the RPCs below.
alter table public.tasks
  add column if not exists description text not null default '',
  add column if not exists description_clock text not null default '0000000000000-0000000000-00000000000000000000000000000000';
...
alter table public.tasks drop constraint if exists tasks_bucket_check;
alter table public.tasks
